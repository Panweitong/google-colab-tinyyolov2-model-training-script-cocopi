...
def generate_training_bash():
    ...
    train_check_content = [
        "nohup " + TRAINING_FULL_COMMAND + " > " + current_directory_path + "/" + conf_directory_name + "/" + project_name + "/" + "nohup.log 2>&1 &\n",
        "OUTPUT_PID=$!\n",
        "echo ${OUTPUT_PID} > " + current_directory_path + "/" + conf_directory_name + "/" + project_name + "/save_pid.txt\n",
        "\n",
        "echo '${OUTPUT_PID}'\n",
...
def generate_testing_bash():
    ...
    bash_content = [
        ...
        "nohup " + TRAINING_FULL_COMMAND + " > " + current_directory_path + "/conf/" + project_name + "/" + project_name + "_test_result.log 2>&1 &\n",
        "TEST_PID=$!\n",
        # # "cpulimit -l 20 -p ${TEST_PID} > /dev/null &\n",
        "echo ${TEST_PID} > " + current_directory_path + "/conf/" + project_name + "/save_test_pid.txt\n",
        # "while true\n",
        # "do\n",
        # "    sleep 1\n",
