...
def generate_subprocess_check_py():
    ...
    train_check_content = [
        ...
        "			if (\"Epoch\" in formatted_output) and (\"Loss\" in formatted_output) and (\"time\" in formatted_output):\n",
		...
		"\n",
		"try:\n",
		"	run_command(\"bash /content/toolkit/conf/" + project_name + "/start-train.sh\")\n",
