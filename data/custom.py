...
class CustomAnnotationTransform(object):
    ...
    def __init__(self, class_to_ind=None, keep_difficult=False, CUSTOM_CLASSES=["load"]):
...
class CustomDetection(data.Dataset):
    ...
    def __init__(self, root,
                 image_sets=['train'],
                 CUSTOM_CLASSES=["load","unload","left","right","forward","stop"],
        ...
        self.target_transform = CustomAnnotationTransform(CUSTOM_CLASSES=self.CUSTOM_CLASSES)
